...
$query = $query." and  sequencias.country like '%".$map_country."%'";
...
<?php
	 $resultado2 = array();
		 ...
		 if($num > 0){		
?>
          <h3>Results for Dengue Serotype 4 in <?php echo $map_country; ?></h3><hr>
  ...
  <!----------------------------------DOWNLOAD-------------------------------------------------------------------->
   ...
   <h3 class="download text-center ">Download File : </h3>
      ...
      <a href="mapadenv4.php" class="btn btn-default">
