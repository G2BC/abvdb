...
if ($map_virus == "ALL") {
    ...
    $query = $query." where geodata.continent like '%".$map_cont."%'";
}
else {
$query = "select *, genotipos.vname,genotipos.genotype,species.id,species.nane,species.specie,geodata.continent,geodata.sub_continent,geodata.geolocator from sequencias inner join genotipos on sequencias.genotype = genotipos.code inner join species on sequencias.host = species.id inner join geodata on sequencias.geolocator=geodata.geolocator";
$query = $query." where sequencias.serotype like '%".$map_virus."%'";
$query = $query." and  geodata.continent like '%".$map_cont."%'"; 
}
...
if ($map_virus == "ALL")    {$virus = "Dengue, Zika and Chikungunya Viruses ";       $mapa ="mapatodos-continent.php";}
if ($map_virus == "DENV")   {$virus = "Dengue Virus ";      $mapa ="mapadenvgeral-continent.php";}	
if ($map_virus == "DENV-1") {$virus = "Dengue Serotype 1 "; $mapa ="mapadenv1-continent.php";}
if ($map_virus == "DENV-2") {$virus = "Dengue Serotype 2 "; $mapa ="mapadenv2-continent.php";}
if ($map_virus == "DENV-3") {$virus = "Dengue Serotype 3 "; $mapa ="mapadenv3-continent.php";}
if ($map_virus == "DENV-4") {$virus = "Dengue Serotype 4 "; $mapa ="mapadenv4-continent.php";}
if ($map_virus == "CHIKV")  {$virus = "Chikungunya Virus "; $mapa ="mapachikv-continent.php";}
if ($map_virus == "ZIKV")   {$virus = "Zika Virus ";        $mapa ="mapazikv-continent.php";}
